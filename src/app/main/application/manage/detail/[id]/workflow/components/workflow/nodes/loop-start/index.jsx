...
import styles from "./loopStart.module.css";
...
const LoopStartNode = ({ id, data }) => {  
  ...
  return (
    <>
      <div onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className={styles.loop_start_node}>
        <img src="/workflow/start.png" className={styles.loop_start_node_icon} />
