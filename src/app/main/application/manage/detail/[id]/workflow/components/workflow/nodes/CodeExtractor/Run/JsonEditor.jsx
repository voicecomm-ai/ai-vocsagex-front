...
const JsonEditor = forwardRef(({ content,title,handleFullscreen,isFullscreen,onChange,onError,varType}, ref) => {
  ...
  return (
    <div className={styles['json_editor_page']}>
      ...
      <div  className={isFullscreen ? styles['json_editor_page_json_fullscreen'] :styles['json_editor_page_json']} ref={containerRef}/>
    </div>
  );
});
