  ...
  return (
    ...
    {runData.error&&(
      <div className={styles["run_panel_result_error"]}>
          ...
          <img className={styles["run_panel_result_error_left"]} src="/workflow/run/error.png" alt="error" />
        
          <Text
                style={{ maxWidth: 345 }}
                ellipsis={{ tooltip: renderErrorContent }}
              >
              <span className={styles["run_panel_result_error_right_text"]}>  {runData.error}</span>
              </Text>
      ...
      <div className={styles["run_panel_footer"]}>
        ...
        <div className={styles["run_panel_footer_item"]}>
          ...
          <div className={styles["run_panel_footer_item_right"]}>{runData.total_tokens} Tokens</div>
        </div>
        <div className={styles["run_panel_footer_item"]}>
          <div className={styles["run_panel_footer_item_left"]}>
            运行步数：
          </div>
          <div className={styles["run_panel_footer_item_right"]}>{runData.total_steps}</div>
        </div>
      </div>
      {isFullscreen&&(
        <div className={styles.fullscreen_container}>
           <JsonEditorPage  handleFullscreen={handleFullscreen} isFullscreen={isFullscreen} title={fullscreenTitle} content={fullscreenData} />
        </div>
      )} 
    </div>
  );
