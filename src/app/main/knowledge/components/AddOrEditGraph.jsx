...
const AddOrEditGraph = forwardRef((props, ref) => {
  //子组件暴露方法
  const router = useRouter();
  const [title, setTitle] = useState("创建图谱知识库"); //标题
  ...
  const showModal = (obj, type) => {
    setOpen(true);
    let modelTitle = type === "add" ? "创建图谱知识库" : "编辑图谱知识库"; //
    setActionType(type);
