    ...
    <div>
      ...
      >
        <div className={styles["panel_content"]}>
          {nodeData.type === "start" ? (
            <StartPanel key={modalKey} setPanelVisible={setPanelVisible} nodeData={nodeData} />
          ) : null}
          {nodeData.type === "end" ? (
            <EndPanel key={modalKey} setPanelVisible={setPanelVisible} nodeData={nodeData} />
          ) : null}
          ...
          {nodeData.type === "document-extractor" ? (
            <DocParsePanel key={modalKey} setPanelVisible={setPanelVisible} nodeData={nodeData} />
          ) : null}
