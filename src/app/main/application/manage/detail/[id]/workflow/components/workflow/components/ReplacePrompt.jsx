    ...
    >
      <div className={`${styles['replace_container']} ${'model_container'}`}>
        <div className={styles['replace_container_content']}>
          <img
            className={styles['replace_container_content_img']}
            src='/agent/replace.png'
          />

          <div className={styles['replace_container_content_right']}>
            <div className={styles['replace_container_content_right_title']}>替换现有内容?</div>
            <div className={styles['replace_container_content_right_tip']}>是否确认替换现有提示词?</div>
          </div>
        </div>
