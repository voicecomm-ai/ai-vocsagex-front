...
const LongMemory = forwardRef((props, ref) => {
  ...
  //获取长期记忆列表
  const getLongMemoryListEvent = (id) => {
    setLoading(true);
    ...
    getAgentLongMemoryUrlList(data)
      .then((res) => {
 ...
 const deleteCallBack = () => {
  ...
  const handleSaveEdit = (e) => {
    ...
    let params = {
      ...
      dataType: 'published',//数据类型 草稿draft，已发布published，试用experience
    };
