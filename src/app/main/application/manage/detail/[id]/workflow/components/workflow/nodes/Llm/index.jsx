...
import llmStyles from "./style.module.css";
...
const Llm = ({ id, data, selected, type }) => {
  ...
  return (
    <div
      ...
      className={`${styles["custom_node"]} ${llmStyles["llm_node"]} ${
    ...
    >
      ...
      >
        ...
        {data.model?.id &&(
        <div className={llmStyles["panel_variable_content"]}>
         
              <div className={llmStyles["llm_node_variable_item"]}>
