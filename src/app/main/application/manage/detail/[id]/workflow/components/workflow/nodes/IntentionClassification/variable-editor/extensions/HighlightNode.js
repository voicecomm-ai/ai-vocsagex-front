...
import VariableNodeView from '../components/VariableNodeView'
 ...
 const HighlightNode = Node.create({
  ...
  addNodeView() {
    ...
    // console.log(this.options,'?????this.options.variables');
    
    return ReactNodeViewRenderer(props => <VariableNodeView {...props} variables={this.options.variables} pannerNodeId={this.options.pannerNodeId}/>)
  }
